	...
	cartObj.cart.add=function(id,image,name,price,qty){
		if( cartObj.cart.find(id)!=-1 ){
			var alertPopup = $ionicPopup.alert({
                ...
                template: 'Incrementa la cantidad en el carrito'
            });
...
.factory('sharedFilterService', [function(){
	...
	var obj = {};
    obj.str = "http://foody1.freetzi.com/food_menu.php?till=";
	obj.sort = "";
	obj.search = "";
	obj.category = "";
	obj.till=0;
	...
	obj.getUrl=function(){
		...
		obj.till=obj.till + 5;
		obj.str="http://foody1.freetzi.com/food_menu.php?till="+obj.till; // pasa el valor a la url
